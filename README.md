...
## <a name='toc'>目录</a>
  ...
  1. [HTML相关问题](#html-questions)
  1. [CSS相关问题](#css-questions)
  1. [JS相关问题](#js-questions)
  ...
  1. [React问题](#react-questions)
  1. [Vue问题](#vue-questions)
 ...
 * 同步会阻塞后面的代码，也就是说假设这个ajax请求要3.5秒，浏览器就会阻塞住3.5秒不执行后面的，直到等到ajax请求完成.(一心一意)
 * 异步发送完请求后,这是浏览器仍然可以作其他事情。(三心二意)
...
#### <a name='react-questions'>React问题</a>
